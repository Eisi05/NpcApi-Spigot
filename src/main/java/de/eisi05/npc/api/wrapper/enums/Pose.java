...
@Mapping(range = @Mapping.Range(from = Versions.V1_17, to = Versions.V1_21_5), path = "net.minecraft.world.entity.EntityPose")
public enum Pose implements Wrapper.EnumWrapper
{
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V1_19, to = Versions.V1_21_5), path = "i")
    CROAKING(getBukkit("CROAKING"), null),

    @Mapping(range = @Mapping.Range(from = Versions.V1_19, to = Versions.V1_21_5), path = "j")
    USING_TONGUE(getBukkit("USING_TONGUE"), null),

    @Mapping(range = @Mapping.Range(from = Versions.V1_19_3, to = Versions.V1_21_5), path = "k")
    SITTING(getBukkit("SITTING"), null),

    @Mapping(range = @Mapping.Range(from = Versions.V1_19_3, to = Versions.V1_21_5), path = "l")
    @Mapping(range = @Mapping.Range(from = Versions.V1_19, to = Versions.V1_19_1), path = "k")
    ROARING(getBukkit("ROARING"), null),

    @Mapping(range = @Mapping.Range(from = Versions.V1_19_3, to = Versions.V1_21_5), path = "m")
    @Mapping(range = @Mapping.Range(from = Versions.V1_19, to = Versions.V1_19_1), path = "l")
    SNIFFING(getBukkit("SNIFFING"), null),

    @Mapping(range = @Mapping.Range(from = Versions.V1_19_3, to = Versions.V1_21_5), path = "n")
    @Mapping(range = @Mapping.Range(from = Versions.V1_19, to = Versions.V1_19_1), path = "m")
    EMERGING(getBukkit("EMERGING"), null),

    @Mapping(range = @Mapping.Range(from = Versions.V1_19_3, to = Versions.V1_21_5), path = "o")
    @Mapping(range = @Mapping.Range(from = Versions.V1_19, to = Versions.V1_19_1), path = "n")
    DIGGING(getBukkit("DIGGING"), null),

    @Mapping(range = @Mapping.Range(from = Versions.V1_20_4, to = Versions.V1_21_5), path = "p")
    SLIDING(getBukkit("SLIDING"), null),

    @Mapping(range = @Mapping.Range(from = Versions.V1_20_4, to = Versions.V1_21_5), path = "q")
    SHOOTING(getBukkit("SHOOTING"), null),

    @Mapping(range = @Mapping.Range(from = Versions.V1_20_4, to = Versions.V1_21_5), path = "r")
