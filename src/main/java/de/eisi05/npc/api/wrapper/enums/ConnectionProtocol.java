...
@Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "net.minecraft.network.ConnectionProtocol")
...
{
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "HANDSHAKE")
    @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21_11), path = "a")
    HANDSHAKE,

    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "PLAY")
    @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21_11), path = "b")
    PLAY,

    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "STATUS")
    @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21_11), path = "c")
    STATUS,

    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "LOGIN")
    @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21_11), path = "d")
    LOGIN,

    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "CONFIGURATION")
