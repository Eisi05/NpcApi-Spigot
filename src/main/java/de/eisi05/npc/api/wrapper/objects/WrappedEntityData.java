...
@Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "net.minecraft.network.syncher.SynchedEntityData")
@Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21_11), path = "net.minecraft.network.syncher.DataWatcher")
public class WrappedEntityData extends Wrapper
{
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "set")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "get")
    @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21_11), path = "a")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "packDirty")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V26_3), path = "markDirty")
    public <T> void markDirty(@NotNull EntityDataAccessor<T> accessor)
    {
        invokeWrappedMethod(accessor);
    }

    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "getNonDefaultValues")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "net.minecraft.network.syncher.EntityDataAccessor")
    @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21_11), path = "net.minecraft.network.syncher.DataWatcherObject")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "net.minecraft.network.syncher.EntityDataSerializer")
    @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21_11), path = "net.minecraft.network.syncher.DataWatcherSerializer")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "net.minecraft.network.syncher.EntityDataSerializers")
    @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21_11), path = "net.minecraft.network.syncher.DataWatcherRegistry")
    public static class EntityDataSerializers extends Wrapper
    {
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "BYTE")
        @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21_11), path = "a")
        public static final EntityDataSerializer<Byte> BYTE = new EntityDataSerializer<>(getStaticWrappedFieldValue("BYTE").orElse(null));

        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "INT")
        @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21_11), path = "b")
        public static final EntityDataSerializer<Integer> INT = new EntityDataSerializer<>(getStaticWrappedFieldValue("INT").orElse(null));

        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "LONG")
        @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21_11), path = "c")
        public static final EntityDataSerializer<Long> LONG = new EntityDataSerializer<>(getStaticWrappedFieldValue("LONG").orElse(null));

        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "FLOAT")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "STRING")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "COMPONENT")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "OPTIONAL_COMPONENT")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "ITEM_STACK")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "BLOCK_STATE")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "OPTIONAL_BLOCK_STATE")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "BOOLEAN")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "PARTICLE")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "PARTICLES")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "ROTATIONS")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "BLOCK_POS")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "OPTIONAL_BLOCK_POS")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "DIRECTION")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "OPTIONAL_LIVING_ENTITY_REFERENCE")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "OPTIONAL_GLOBAL_POS")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "VILLAGER_DATA")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "OPTIONAL_UNSIGNED_INT")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "POSE")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "VECTOR3")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "QUARTERNION")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "RESOLVABLE_PROFILE")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "HUMANOID_ARM")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_3, to = Versions.V26_3), path = "DYE_COLOR")
        public static final EntityDataSerializer<?> DYE_COLOR = new EntityDataSerializer<>(
                getStaticWrappedFieldValue("DYE_COLOR").orElse(null));
