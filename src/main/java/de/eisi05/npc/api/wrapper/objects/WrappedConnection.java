...
@Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "net.minecraft.server.network.ServerGamePacketListenerImpl")
...
public class WrappedConnection extends Wrapper
{
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "sendPacket")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "net.minecraft.network.Connection")
    ...
    public static class WrappedNetworkManager extends Wrapper
    {
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "channel")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "net.minecraft.network.protocol.PacketFlow")
        ...
        {
            @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "SERVERBOUND")
            @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21_11), path = "a")
            SERVERBOUND,

            @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "CLIENTBOUND")
            @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21_11), path = "b")
            CLIENTBOUND;
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V26_3), path = "net.minecraft.server.network.CommonListenerCookie")
