...
@Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "net.minecraft.world.entity.ai.attributes.AttributeInstance")
...
public class WrappedAttributeInstance extends Wrapper
{
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "setBaseValue")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "net.minecraft.world.entity.ai.attributes.Attributes")
    ...
    {
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "SCALE")
