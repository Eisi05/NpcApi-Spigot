...
@Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_2), path = "net.minecraft.world.phys.Vec3")
@Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21_11), path = "net.minecraft.world.phys.Vec3D")
public class WrappedVec3D extends Wrapper
{
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_2), path = "x")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_2), path = "y")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_2), path = "z")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21), path = "e")
    public double getZ()
    {
        return getWrappedFieldValue();
    }
