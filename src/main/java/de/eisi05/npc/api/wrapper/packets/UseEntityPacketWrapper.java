...
@Mapping(range = @Mapping.Range(from = Versions.V1_17, to = Versions.V1_21_5), path = "net.minecraft.network.protocol.game.PacketPlayInUseEntity")
public class UseEntityPacketWrapper extends PacketWrapper.PacketHolder
{
    @Mapping(range = @Mapping.Range(from = Versions.V1_21, to = Versions.V1_21_5), path = "e")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V1_21, to = Versions.V1_21_5), path = "b")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V1_21, to = Versions.V1_21_5), path = "c")
