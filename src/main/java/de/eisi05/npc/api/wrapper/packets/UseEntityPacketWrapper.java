...
@Mapping(range = @Mapping.Range(from = Versions.V1_17, to = Versions.V1_21_6), path = "net.minecraft.network.protocol.game.PacketPlayInUseEntity")
public class UseEntityPacketWrapper extends PacketWrapper.PacketHolder
{
    @Mapping(range = @Mapping.Range(from = Versions.V1_21, to = Versions.V1_21_6), path = "e")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V1_21, to = Versions.V1_21_6), path = "b")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V1_21, to = Versions.V1_21_6), path = "c")
