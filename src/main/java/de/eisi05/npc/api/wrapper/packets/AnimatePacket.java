...
@Mapping(range = @Mapping.Range(from = Versions.V1_17, to = Versions.V1_21_5), path = "net.minecraft.network.protocol.game.PacketPlayOutAnimation")
public class AnimatePacket extends PacketWrapper
{
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V1_19_4, to = Versions.V1_21_5),
