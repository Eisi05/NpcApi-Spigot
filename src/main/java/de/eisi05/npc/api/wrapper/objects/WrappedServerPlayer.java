...
@Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "net.minecraft.server.level.ServerPlayer")
@Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21_11), path = "net.minecraft.server.level.EntityPlayer")
public class WrappedServerPlayer extends WrappedEntity<Player>
{
                                                      ...
                                                      @NotNull WrappedComponent name, @Nullable WrappedNameTag<?> nameDisplay)
    {
        ...
        {
            case V1_20_6, V1_21, V1_21_2, V1_21_4, V1_21_5, V1_21_6, V1_21_9, V1_21_11, V26_1, V26_2, V26_3 ->
            {
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "getAttribute")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "getGameProfile")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "connection")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21), path = "c")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V26_3), path = "listName")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V26_3), path = "listOrder")
    public void setListOrder(int order)
    {
        setWrappedFieldValue(order);
    }

    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "setPose")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "createCommandSourceStack")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "stopUsingItem")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "sendSystemMessage")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "removePlayerImmediately")
    @Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V1_21_11), path = "a")
    public void remove()
    {
        map.remove(getUUID());
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_2, to = Versions.V26_3), path = "getAdvancements-clearTriggers")
    @Mapping(fixed = @Mapping.Fixed(Versions.V26_1), path = "getAdvancements-stopListening")
    ...
    @Mapping(fixed = @Mapping.Fixed(Versions.V1_20_6), path = "Q-a")
