...
@Mapping(range = @Mapping.Range(from = Versions.V1_17, to = Versions.V1_21_6), path = "net.minecraft.network.chat.IChatBaseComponent")
public class WrappedComponent extends Wrapper
{
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V1_19_1, to = Versions.V1_21_6), path = "b")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V1_20_4, to = Versions.V1_21_6), path = "f")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V1_17, to = Versions.V1_21_6), path = "net.minecraft.network.chat.ChatClickable")
    public static class ClickEvent extends Wrapper
    {
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V1_17, to = Versions.V1_21_6),
        ...
        public enum ClickAction implements EnumWrapper
        {
            ...
            @Mapping(range = @Mapping.Range(from = Versions.V1_21_6, to = Versions.V1_21_6), path = "e")
            SHOW_DIALOG(ShowDialog::new),

            @Mapping(range = @Mapping.Range(from = Versions.V1_21_6, to = Versions.V1_21_6), path = "f")
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V1_21_5, to = Versions.V1_21_6),
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V1_21_6, to = Versions.V1_21_6),
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V1_17, to = Versions.V1_21_6), path = "net.minecraft.network.chat.ChatHoverable")
    public static class HoverEvent extends Wrapper
    {
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V1_21_5, to = Versions.V1_21_6), path = "net.minecraft.network.chat.ChatHoverable$e")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V1_17, to = Versions.V1_21_6), path = "net.minecraft.network.chat.ChatModifier")
