...
public class WrappedEntitySnapshot implements Serializable
{
     ...
     */
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "net.minecraft.nbt.CompoundTag")
    ...
    public static class WrappedCompoundTag extends Wrapper
    {
         ...
         */
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "putString")
         ...
         */
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "getBooleanOr")
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "net.minecraft.nbt.NbtAccounter")
    ...
    public static class NbtAccounter extends Wrapper
    {
        ...
        @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "unlimitedHeap")
