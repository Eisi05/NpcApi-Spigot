...
@Mapping(range = @Mapping.Range(from = Versions.V1_20_6, to = Versions.V26_3), path = "net.minecraft.server.level.ClientInformation")
public class WrappedClientInformation extends Wrapper
{
    ...
    @Mapping(range = @Mapping.Range(from = Versions.V26_1, to = Versions.V26_3), path = "createDefault")
