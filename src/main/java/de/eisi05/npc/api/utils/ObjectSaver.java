...
public class ObjectSaver
{
    ...
    /**
     * Writes a single serializable object to the file, appending to the file if it already exists. This is a convenience method that calls
     * {@link #write(Serializable, boolean)} with {@code append} set to {@code true}.
     *
     ...
     *
     * @param object The object to write to the file. Must implement {@link Serializable}.
     * @param append If {@code true}, the object will be appended to the end of the file. If {@code false}, the file will be truncated (its contents deleted)
    ...
    /**
     * Writes a list of serializable objects to the file, appending to the file if it already exists. This is a convenience method that calls
     * {@link #writeList(List, boolean)} with {@code append} set to {@code true}.
     *
     ...
     *
     * @param object The list of objects to write to the file. Each object in the list must implement {@link Serializable}. Must not be {@code null}.
     * @param append If {@code true}, the list will be appended to the end of the file. If {@code false}, the file will be truncated (its contents deleted)
     ...
     * @return The deserialized list of objects. Returns an empty {@link ArrayList} if an error occurs during reading (e.g., file not found, EOF, class not
     * found, or I/O error), or if the file is empty.
     */
    @SuppressWarnings("unchecked")
